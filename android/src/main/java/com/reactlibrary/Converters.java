...
public class Converters {
    ...
    @NonNull
    private static WritableMap convertBankAccountToWritableMap(BankAccount account) {
        WritableMap result = Arguments.createMap();
    ...
    private static String getValue(final ReadableMap map, final String key, final String def) {
        if (map.hasKey(key)) {
    ...
    private static String getValue(final ReadableMap map, final String key) {
    ...
    @NonNull
    private static WritableMap stringMapToWritableMap(@Nullable Map<String, String> map) {
    ...
    @NonNull
    private static WritableMap convertOwnerToWritableMap(@Nullable final SourceOwner owner) {
    ...
    @NonNull
    private static WritableMap mapToWritableMap(@Nullable Map<String, Object> map) {
        WritableMap writableMap = Arguments.createMap();
    ...
    private static void pushRightTypeToMap(@NonNull WritableMap map, @NonNull String key, @NonNull Object object) {
